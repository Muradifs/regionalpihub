    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-slate-50 text-center">
        ...
        <div className="flex flex-col items-center">
          <p className="text-slate-500 mb-4 text-xs font-bold uppercase tracking-widest">
             Klikni gumb ispod za pristup:
          </p>
          <button 
            onClick={() => auth.reinitialize()}
            className="bg-[#8A2BE2] hover:bg-[#7B1FA2] text-white px-12 py-5 rounded-2xl font-black shadow-xl active:scale-95 transition-all animate-bounce"
          >
